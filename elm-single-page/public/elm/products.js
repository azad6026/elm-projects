...
var $author$project$Product$getInitialSelectedOptionId = function (options) {
	var _v0 = A2(
...
var $author$project$Product$getSelectedOption = function (options) {
	var _v0 = A2(
		$elm$core$List$filter,
		function (option) {
			return option.selected;
...
var $author$project$Product$sampleProduct = {
...
var $author$project$Product$init = function (_v0) {
	return _Utils_Tuple2(
		{
			product: $author$project$Product$sampleProduct,
			selectedImageUrl: $author$project$Product$getSelectedOption($author$project$Product$sampleProduct.options).imageUrlOuter,
			selectedOptionId: $author$project$Product$getInitialSelectedOptionId($author$project$Product$sampleProduct.options)
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Product$getSelectedItem = F2(
	function (id, product) {
		var _v0 = A2(
			$elm$core$List$filter,
			function (option) {
...
var $author$project$Product$update = F2(
	function (msg, model) {
		if (msg.$ === 'ChangedSelection') {
			...
			var updatedOptions = {description: model.product.description, options: selectedOptions, title: model.product.title};
			var selectedOption = A2($author$project$Product$getSelectedItem, id, model.product.options);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{product: updatedOptions, selectedImageUrl: selectedOption.imageUrlOuter, selectedOptionId: selectedOption.id}),
				$elm$core$Platform$Cmd$none);
		} else {
			var id = msg.a;
			var imageUrl = msg.b;
...
var $author$project$Product$ToggledImage = F2(
	function (a, b) {
...
var $author$project$Product$ChangedSelection = function (a) {
...
var $author$project$Product$viewOption = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Events$onInput($author$project$Product$ChangedSelection),
...
var $author$project$Product$view = function (model) {
	var option = $author$project$Product$getSelectedOption(model.product.options);
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Product$ToggledImage, model.selectedOptionId, imageUrl))
							]),
						_List_fromArray(
							[
				...
				A2(
					$elm$core$List$map,
					$author$project$Product$viewOption(model.selectedOptionId),
					model.product.options))
			]));
};
var $author$project$Product$main = $elm$browser$Browser$element(
	{
		init: $author$project$Product$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Product$update,
		view: $author$project$Product$view
	});
var $author$project$Products$main = $author$project$Product$main;
_Platform_export({'Products':{'init':$author$project$Products$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Product.Msg","aliases":{},"unions":{"Product.Msg":{"args":[],"tags":{"ChangedSelection":["String.String"],"ToggledImage":["String.String","String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));