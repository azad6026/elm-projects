...
var $author$project$Items$Loading = {$: 'Loading'};
var $author$project$Items$GotItems = function (a) {
	return {$: 'GotItems', a: a};
};
...
var $author$project$Items$Option = F7(
...
var $author$project$Items$optionDecoder = A4(
...
var $author$project$Items$itemsDecoder = A2(
	...
	A2(
		$elm$json$Json$Decode$field,
		'items',
		$elm$json$Json$Decode$list($author$project$Items$itemDecoder)));
var $author$project$Items$httpRequest = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Items$GotItems, $author$project$Items$itemsDecoder),
		url: '/elm/items.json'
	});
var $author$project$Items$init = function (_v0) {
	return _Utils_Tuple2($author$project$Items$Loading, $author$project$Items$httpRequest);
};
...
var $author$project$Items$Red = {$: 'Red'};
var $author$project$Items$Royalblue = {$: 'Royalblue'};
var $elm$core$String$toLower = _String_toLower;
var $author$project$Items$stringToNewOption = function (color) {
	var _v0 = $elm$core$String$toLower(color);
	switch (_v0) {
		case 'yellow':
			return $author$project$Items$Yellow;
		case 'red':
			return $author$project$Items$Red;
		case 'royalblue':
			return $author$project$Items$Royalblue;
		case 'green':
			return $author$project$Items$Green;
		default:
			return $author$project$Items$Yellow;
	}
};
var $author$project$Items$viewOption = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$for('group' + item.id)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$id('group' + item.id),
							$elm$html$Html$Attributes$name('options-' + item.id),
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(
									$elm$core$List$map,
									$author$project$Items$viewOption(item),
									item.options))
							]))
					]))
			]));
	...
	switch (model.$) {
		case 'Loading':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Loading items ...')
					]));
		case 'Success':
			var data = model.a;
			return $author$project$Items$viewItems(data);
		default:
			return A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('We are not able to load items now ...')
					]));
	}
};
var $author$project$Items$main = $elm$browser$Browser$element(
	{
		init: $author$project$Items$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Items$update,
